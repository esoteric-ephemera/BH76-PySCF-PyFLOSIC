...
def pycom_guess(ase_nuclei,charge,spin,basis,xc,method='FB',ecp=None,newton=False,grid=3,BS=None,calc='UKS',symmetry=False,verbose=4,write_cubes=False,stability_analysis=True,levelshift=0.0):
    ...
    Args:
            ...
            levelshift :            level shift to help speed convergence
